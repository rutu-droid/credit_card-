							...
							<center>
								<table>
									<tr>
										...
										<td><img src="images/correct.JPG" style="width: 30px ; height: 30px"></img></td>
									...
									<tr>
										...
										<td><input type="text" name="que2" id="que2" value='<%=que2%>' style="width: 200px; height: 30px"/></td>
										<td></td>
										<td><font size="4"><strong>Answer</strong></font></td>
										<td><input type="password" name="ans2" id="ans2" style="width: 200px ; height: 30px"/></td>
										<td>
